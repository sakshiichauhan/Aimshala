    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-b from-[#FFF5FF] to-[#F0F8F8] font-poppins p-4">
      <div className="w-[768px] bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div className="bg-[#F5F5F5] rounded-t-lg flex items-center min-h-[60px] px-6">
          <h1 className="text-2xl font-semibold text-[#1C1C1C]">Add Project</h1>
        </div>
        ...
        <div className="px-8 py-6 space-y-6">
          ...
          <div className="relative flex justify-center">
            <div className="relative w-full max-w-[530px]">
              ...
              <textarea
                ...
                maxLength={150}
                className="w-full h-[100px] px-4 py-2 border border-[#DCDCDC] rounded-md text-[16px] text-[#898989] resize-none focus:outline-none"
              />
          ...
          <div className="w-full max-w-[530px] mx-auto mt-8">
            <h2 className="text-lg font-semibold text-black mb-4">Additional Details</h2>
            ...
            <div className="flex justify-between gap-4">
              <div className="relative w-full max-w-[260px]">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full h-[68px] px-4 pr-10 border border-[#DCDCDC] rounded-md text-[16px] text-[#898989] focus:outline-none"
                />
