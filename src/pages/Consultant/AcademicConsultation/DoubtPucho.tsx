          ...
          <div>
            ...
            <div className="flex gap-2">
              <button
                ...
                className={`w-[171px] h-[43px] flex items-center justify-center rounded-[40px] border text-[18px] transition-all duration-200 ease-in-out rotate-[-0.28deg] ${
                  followUp === "allow"
                    ? " border-[#94278F] text-[#94278F] bg-white"
                    : " border-[#DCDCDC] text-[#000000] bg-white"
                }`}
              ...
              <button
                ...
                className={`w-[219px] h-[43px] flex items-center justify-center rounded-[40px] border text-[18px] transition-all duration-200 ease-in-out rotate-[-0.28deg] ${
                  followUp === "disallow"
                    ? " border-[#94278F] text-[#94278F] bg-white"
                    : " border-[#DCDCDC] text-[#000000] bg-white"
                }`}
