...
const areasOfExpertiseList = [
  { key: "careerGrowth", label: "Carrer Growth" },
  { key: "networking", label: "Networking" },
  { key: "careertransition", label: "Career Transition" },
  { key: "jobMarketTrends", label: "Job Market Trends" },
  { key: "skilldevelopment", label: "Skill Development" },
  { key: "salarynegotiation", label: "Salary Negotiation" },
  { key: "worklifebalance", label: "Work-Life Balance" },
  { key: "entrepreneurship", label: "Entrepreneurship" },
  { key: "workplacechallenges", label: "Workplace Challenges" },
  { key: "higherEducation", label: "HigherEducation" },
];

const targetGroupList = [
  { key: "professionals", label: "Professionals" },
  { key: "enterprenuers", label: "Enterprenuers" },
  { key: "careerChangers", label: "Career changers" },
  { key: "homeMakers", label: "Home Makers" },
];
        ...
        <div className="w-[791px] bg-white rounded-lg shadow-lg pt-6 pb-8 px-8 flex flex-col gap-6">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full p-3 pl-[16px] border border-[#DCDCDC] rounded-md focus:outline-none focus:ring-2 focus:ring-[#94278F]/20 placeholder-[#898989]"
            />
          </div>
          ...
          <div className="flex justify-between items-center pt-4 gap-[10px]">
            <button
              onClick={handleDelete}
              className="text-[#000000] text-[20px] font-medium"
            >
              Delete Expertise
            </button>
            <button
              onClick={handleSave}
              className="bg-[#94278F] text-white w-[170px] h-[46px] rounded-[12px] text-sm font-medium hover:bg-[#7A206F] transition-colors flex items-center justify-center"
            >
              Save
            </button>
          </div>
